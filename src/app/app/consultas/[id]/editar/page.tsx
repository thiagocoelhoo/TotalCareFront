...
import { ConsultaType, MedicoType, PacienteType } from "@/app/schemas";
...
import BuscarPaciente from "@/app/app/consultas/components/BuscarPaciente";
...
export default function EditarConsulta() {
    ...
    function onSubmit(event) {
        ...
        api.put(`/consultas/${consultaId}`, payload).then(
            (response) => {
